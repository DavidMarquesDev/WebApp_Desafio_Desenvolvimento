...
namespace WebApp_Desafio_FrontEnd.ApiClients.Desafio_API
{
    public class DepartamentosApiClient : BaseClient
    {
        ...
        private const string departamentosEditarUrl = "api/Departamentos/Editar";
        ...
        public DepartamentoViewModel DepartamentosObter(int idDepartamento)
        {
            var headers = new Dictionary<string, object>()
            {
                { "TokenAutenticacao", tokenAutenticacao }
        ...
        public bool DepartamentosGravar(DepartamentoViewModel departamento)
        {
            var headers = new Dictionary<string, object>()
            {
                { "TokenAutenticacao", tokenAutenticacao }
        ...
        public bool DepartamentosEditar(DepartamentoViewModel departamento)
        {
            var headers = new Dictionary<string, object>()
            {
                { "TokenAutenticacao", tokenAutenticacao }
            ...
            var response = base.Put($"{desafioApiUrl}{departamentosEditarUrl}", departamento, headers);
        ...
        public bool DepartamentosExcluir(int idDepartamento)
        {
            var headers = new Dictionary<string, object>()
            {
                { "TokenAutenticacao", tokenAutenticacao }
